...
using static NetcoreTemplate.Common.ErrorHandling.Helpers;
...
namespace NetcoreTemplate.Domain.Core.User.Query.FindUser
{
    public class FindUserQueryHandler : IRequestHandler<FindUserQuery, Result<Entity.User, Error>>
    {
        ...
        protected readonly INetcoreTemplateDbContext DbContext;

        public FindUserQueryHandler(ILogger<FindUserQueryHandler> logger, INetcoreTemplateDbContext dbContext)
        {
            Logger = logger;
            DbContext = dbContext;
        }
